...
// TODO-BEN:	memcpy(&mvif->last_mcu.bss_info_basic, bss, sizeof(*bss));

// TODO-BEN: connac_mcu_bss_omac_tlv:	memcpy(&mvif->last_mcu.bss_info_omac, omac, sizeof(*omac));
...
// TODO-BEN:	memcpy(&mvif->last_mcu.bss_info_ext_bss, ext, sizeof(*ext));
...
//TODO-BEN:	memcpy(&msta->last_mcu.wtbl_rx, rx, sizeof(*rx));
//TODO-BEN	memcpy(&msta->last_mcu.sta_rec_basic, basic, sizeof(*basic));
		       ...
		       struct mt7915_sta *msta)
{
	...
	memcpy(&msta->last_mcu.sta_rec_vht, vht, sizeof(*vht));
}

static void
mt7915_mcu_sta_amsdu_tlv(struct mt7915_dev *dev, struct sk_buff *skb, struct ieee80211_vif *vif,
			 struct ieee80211_sta *sta, struct mt7915_sta *msta)
{
...
//TODO-BEN:	memcpy(&msta->last_mcu.wtbl_smps, smps, sizeof(*smps));
//TODO-BEN:		memcpy(&msta->last_mcu.wtbl_vht, vht, sizeof(*vht));
//TODO-BEN:	memcpy(&msta->last_mcu.wtbl_ht, ht, sizeof(*ht));
//TODO-BEN:	memcpy(&msta->last_mcu.wtbl_hdr_trans, htr, sizeof(*htr));
			     ...
			     struct ieee80211_vif *vif, struct ieee80211_sta *sta)
{
	...
	memcpy(&msta->last_mcu.sta_rec_ra, ra, sizeof(*ra));
}
		       ...
		       struct ieee80211_sta *sta, bool enable)
{
	...
	if (sta && sta->ht_cap.ht_supported) {
		/* starec amsdu */
		mt7915_mcu_sta_amsdu_tlv(dev, skb, vif, sta, msta);
		/* starec he */
		mt7915_mcu_sta_he_tlv(skb, sta, vif);
		/* starec muru */
